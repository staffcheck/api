<?php
require_once( '../../classes/modules/api/client/SoapClientAPI.class.php' );

/*
 Global variables
*/
$URL = 'https://{YOUR DOMAIN NAME}/next-release/api/soap/api.php';
$USERNAME = 'demoadmin1';
$PASSWORD = 'demo';
...
//
$user_obj = new SoapClientAPI( 'User' );
...
//
$new_hire_defaults_obj = new SoapClientAPI( 'UserDefault' );
...
//
$punch_obj = new SoapClientAPI( 'Punch' );
$punch_data = array(
...
//
$report_obj = new SoapClientAPI( 'TimesheetSummaryReport' );
